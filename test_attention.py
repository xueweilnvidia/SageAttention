...
q = torch.randn((batch_size, head_num, seq_len, head_dim), dtype=torch.bfloat16).cuda()
k = torch.randn((batch_size, head_num, seq_len, head_dim), dtype=torch.bfloat16).cuda()
v = torch.randn((batch_size, head_num, seq_len, head_dim), dtype=torch.bfloat16).cuda()
...
print("attn_output",rearrange(attn_output, "b s h d -> (b s) h d"))
